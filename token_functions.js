      ...
      const response = await fetch('https://api.aimlapi.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are an expert in dba SQL mssql 2016 sp3. Review the stored procedure that is passed to you and optimize it since it consumes a lot of cpu'
            },
            {
              role: 'user',
              content: `Here is my SQL stored procedure :\n\n${code}\n\ `
            }
          ]
        })
      });
